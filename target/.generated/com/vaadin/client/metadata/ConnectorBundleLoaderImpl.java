...
public class ConnectorBundleLoaderImpl extends com.vaadin.client.metadata.ConnectorBundleLoader {
  public void init() {
    addAsyncBlockLoader(new AsyncBundleLoader("__eager", new String[] {"com.vaadin.ui.AbstractJavaScriptComponent","com.vaadin.ui.NativeButton","com.vaadin.server.AbstractJavaScriptExtension","com.vaadin.ui.Audio","com.vaadin.ui.Flash","com.vaadin.ui.Video","com.vaadin.ui.MenuBar","com.vaadin.ui.Embedded","com.vaadin.ui.Button","com.vaadin.ui.TextArea","com.vaadin.ui.BrowserFrame","com.vaadin.ui.TextField","com.vaadin.ui.DragAndDropWrapper","com.vaadin.ui.PasswordField","com.vaadin.ui.ProgressIndicator","com.vaadin.ui.DateField","com.vaadin.ui.Window","com.vaadin.server.FileDownloader","com.vaadin.ui.Link","com.vaadin.ui.UI","com.vaadin.ui.CheckBox","com.vaadin.ui.CustomField","com.vaadin.ui.CssLayout","com.vaadin.ui.GridLayout","com.vaadin.ui.VerticalLayout","com.vaadin.ui.HorizontalLayout","com.vaadin.ui.Accordion","com.vaadin.ui.VerticalSplitPanel","com.vaadin.ui.Table","com.vaadin.ui.JavaScript","com.vaadin.ui.AbsoluteLayout","com.vaadin.ui.TreeTable","com.vaadin.ui.CustomLayout","com.vaadin.ui.Upload","com.vaadin.ui.HorizontalSplitPanel","com.vaadin.ui.ListSelect","com.vaadin.server.BrowserWindowOpener","com.vaadin.ui.TwinColSelect","com.vaadin.ui.FormLayout","com.vaadin.ui.TabSheet","com.vaadin.ui.ProgressBar","com.vaadin.ui.Slider","com.vaadin.ui.ComboBox","com.vaadin.ui.InlineDateField","com.vaadin.ui.OptionGroup","com.vaadin.ui.NativeSelect","com.vaadin.ui.CustomComponent","com.vaadin.ui.Image","com.vaadin.ui.PopupView","com.vaadin.ui.Form","com.vaadin.ui.Panel","com.vaadin.ui.Label","com.vaadin.ui.Tree",}) {
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load2() {
            ...
            store.setProperties(com.vaadin.shared.ui.orderedlayout.AbstractOrderedLayoutState.class, new String[] {"childData", "styles", "spacing", "marginsBitmask", "width", "errorMessage", "registeredEventListeners", "primaryStyleName", "immediate", "caption", "enabled", "readOnly", "height", "resources", "description", "id", });
            store.setProperties(com.vaadin.shared.ui.video.VideoState.class, new String[] {"caption", "width", "errorMessage", "sources", "styles", "htmlContentAllowed", "autoplay", "showControls", "altText", "sourceTypes", "readOnly", "height", "enabled", "immediate", "description", "registeredEventListeners", "primaryStyleName", "muted", "resources", "id", });
            store.setProperties(com.vaadin.shared.extension.javascriptmanager.JavaScriptManagerState.class, new String[] {"resources", "registeredEventListeners", "enabled", "names", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.HorizontalLayoutState.class, new String[] {"styles", "marginsBitmask", "description", "caption", "spacing", "errorMessage", "childData", "resources", "registeredEventListeners", "readOnly", "height", "width", "primaryStyleName", "immediate", "enabled", "id", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.AbstractSplitPanelState.SplitterState.class, new String[] {"positionReversed", "positionUnit", "minPosition", "minPositionUnit", "maxPositionUnit", "locked", "position", "maxPosition", });
            store.setProperties(com.vaadin.shared.ui.menubar.MenuBarState.class, new String[] {"errorMessage", "styles", "readOnly", "width", "id", "resources", "enabled", "registeredEventListeners", "description", "tabIndex", "immediate", "height", "caption", "primaryStyleName", });
            ...
            store.setProperties(com.vaadin.shared.ui.customlayout.CustomLayoutState.class, new String[] {"width", "caption", "description", "enabled", "templateName", "styles", "resources", "primaryStyleName", "registeredEventListeners", "childLocations", "immediate", "templateContents", "id", "height", "readOnly", "errorMessage", });
            store.setProperties(com.vaadin.shared.ui.gridlayout.GridLayoutState.ChildComponentData.class, new String[] {"column1", "column2", "row1", "row2", "alignment", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.VerticalSplitPanelState.class, new String[] {"width", "errorMessage", "enabled", "caption", "registeredEventListeners", "styles", "resources", "firstChild", "id", "description", "secondChild", "splitterState", "immediate", "readOnly", "primaryStyleName", "height", });
            store.setProperties(com.vaadin.shared.ui.tabsheet.TabsheetState.class, new String[] {"caption", "width", "enabled", "errorMessage", "description", "primaryStyleName", "registeredEventListeners", "styles", "readOnly", "height", "id", "immediate", "resources", });
            store.setProperties(com.vaadin.shared.ui.flash.FlashState.class, new String[] {"registeredEventListeners", "width", "standby", "id", "codetype", "styles", "height", "resources", "errorMessage", "description", "primaryStyleName", "caption", "embedParams", "codebase", "enabled", "classId", "alternateText", "immediate", "archive", "readOnly", });
            store.setProperties(com.vaadin.shared.ui.link.LinkState.class, new String[] {"errorMessage", "enabled", "id", "primaryStyleName", "height", "styles", "resources", "width", "caption", "registeredEventListeners", "readOnly", "immediate", "description", });
            store.setProperties(com.vaadin.shared.ui.browserframe.BrowserFrameState.class, new String[] {"primaryStyleName", "description", "readOnly", "resources", "height", "immediate", "enabled", "caption", "id", "alternateText", "width", "styles", "errorMessage", "registeredEventListeners", });
            store.setProperties(com.vaadin.shared.ui.BrowserWindowOpenerState.class, new String[] {"immediate", "primaryStyleName", "resources", "features", "caption", "width", "uriFragment", "id", "description", "registeredEventListeners", "enabled", "styles", "errorMessage", "target", "parameters", "readOnly", "height", });
            store.setProperties(com.vaadin.shared.ui.ui.UIState.TooltipConfigurationState.class, new String[] {"maxWidth", "quickOpenTimeout", "quickOpenDelay", "openDelay", "closeTimeout", });
            store.setProperties(com.vaadin.shared.ui.optiongroup.OptionGroupState.class, new String[] {"required", "width", "primaryStyleName", "hideErrors", "height", "description", "resources", "readOnly", "immediate", "styles", "errorMessage", "modified", "registeredEventListeners", "tabIndex", "id", "enabled", "caption", "propertyReadOnly", });
            store.setProperties(com.vaadin.shared.ui.treetable.TreeTableState.class, new String[] {"styles", "errorMessage", "tabIndex", "id", "primaryStyleName", "width", "required", "enabled", "height", "hideErrors", "resources", "caption", "readOnly", "modified", "immediate", "propertyReadOnly", "description", "registeredEventListeners", });
            store.setProperties(com.vaadin.shared.ui.slider.SliderState.class, new String[] {"styles", "errorMessage", "description", "minValue", "propertyReadOnly", "registeredEventListeners", "primaryStyleName", "height", "orientation", "id", "maxValue", "hideErrors", "immediate", "required", "caption", "value", "resolution", "modified", "width", "readOnly", "resources", "tabIndex", "enabled", });
            store.setProperties(com.vaadin.shared.AbstractComponentState.class, new String[] {"enabled", "caption", "errorMessage", "resources", "height", "width", "primaryStyleName", "description", "id", "styles", "registeredEventListeners", "immediate", "readOnly", });
            store.setProperties(com.vaadin.shared.ui.panel.PanelState.class, new String[] {"id", "errorMessage", "registeredEventListeners", "immediate", "caption", "readOnly", "primaryStyleName", "scrollLeft", "scrollTop", "height", "description", "enabled", "resources", "tabIndex", "styles", "width", });
            store.setProperties(com.vaadin.shared.ui.button.ButtonState.class, new String[] {"caption", "primaryStyleName", "iconAltText", "disableOnClick", "width", "tabIndex", "resources", "enabled", "htmlContentAllowed", "errorMessage", "immediate", "clickShortcutKeyCode", "height", "styles", "registeredEventListeners", "readOnly", "id", "description", });
            store.setProperties(com.vaadin.shared.ui.tree.TreeState.class, new String[] {"primaryStyleName", "description", "required", "readOnly", "errorMessage", "modified", "hideErrors", "width", "enabled", "resources", "caption", "immediate", "id", "registeredEventListeners", "propertyReadOnly", "height", "styles", "tabIndex", });
            store.setProperties(com.vaadin.shared.ui.combobox.ComboBoxState.class, new String[] {"modified", "immediate", "caption", "registeredEventListeners", "errorMessage", "required", "readOnly", "hideErrors", "primaryStyleName", "id", "width", "height", "resources", "tabIndex", "styles", "enabled", "description", "propertyReadOnly", });
            store.setProperties(com.vaadin.shared.ui.csslayout.CssLayoutState.class, new String[] {"styles", "errorMessage", "primaryStyleName", "readOnly", "childCss", "width", "enabled", "id", "caption", "registeredEventListeners", "immediate", "height", "description", "resources", });
            store.setProperties(com.vaadin.shared.ui.gridlayout.GridLayoutState.class, new String[] {"width", "description", "enabled", "readOnly", "immediate", "styles", "rows", "childData", "caption", "primaryStyleName", "spacing", "columns", "registeredEventListeners", "marginsBitmask", "height", "errorMessage", "id", "resources", });
            store.setProperties(com.vaadin.shared.ui.progressindicator.ProgressIndicatorState.class, new String[] {"registeredEventListeners", "resources", "propertyReadOnly", "styles", "enabled", "primaryStyleName", "state", "tabIndex", "required", "hideErrors", "caption", "width", "errorMessage", "id", "indeterminate", "height", "immediate", "readOnly", "description", "modified", "pollingInterval", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.VerticalLayoutState.class, new String[] {"childData", "height", "registeredEventListeners", "errorMessage", "styles", "primaryStyleName", "resources", "width", "id", "readOnly", "caption", "enabled", "marginsBitmask", "spacing", "immediate", "description", });
            store.setProperties(com.vaadin.shared.ui.label.LabelState.class, new String[] {"height", "registeredEventListeners", "contentMode", "width", "text", "readOnly", "description", "resources", "styles", "caption", "primaryStyleName", "enabled", "errorMessage", "immediate", "id", });
            store.setProperties(java.util.Date.class, new String[] {"month", "time", "seconds", "hours", "year", "date", "minutes", });
            store.setProperties(com.vaadin.shared.ui.absolutelayout.AbsoluteLayoutState.class, new String[] {"primaryStyleName", "description", "enabled", "id", "height", "readOnly", "styles", "errorMessage", "registeredEventListeners", "caption", "resources", "width", "connectorToCssPosition", "immediate", });
            store.setProperties(com.vaadin.shared.ui.textfield.AbstractTextFieldState.class, new String[] {"inputPrompt", "height", "readOnly", "primaryStyleName", "registeredEventListeners", "enabled", "modified", "hideErrors", "immediate", "width", "description", "id", "propertyReadOnly", "maxLength", "text", "errorMessage", "tabIndex", "styles", "columns", "required", "resources", "caption", });
            store.setProperties(com.vaadin.shared.ui.ui.UIState.PushConfigurationState.class, new String[] {"mode", "parameters", });
            store.setProperties(com.vaadin.shared.ui.textarea.TextAreaState.class, new String[] {"width", "wordwrap", "immediate", "enabled", "hideErrors", "errorMessage", "primaryStyleName", "tabIndex", "inputPrompt", "height", "id", "caption", "required", "rows", "modified", "description", "resources", "readOnly", "registeredEventListeners", "text", "styles", "maxLength", "columns", "propertyReadOnly", });
            store.setProperties(com.vaadin.shared.MouseEventDetails.class, new String[] {"altKey", "shiftKey", "clientX", "type", "ctrlKey", "clientY", "relativeX", "relativeY", "button", "metaKey", });
            store.setProperties(com.vaadin.shared.ui.datefield.InlineDateFieldState.class, new String[] {"styles", "readOnly", "tabIndex", "immediate", "rangeEnd", "registeredEventListeners", "description", "caption", "resources", "width", "enabled", "rangeStart", "hideErrors", "id", "primaryStyleName", "propertyReadOnly", "height", "required", "modified", "errorMessage", });
            store.setProperties(com.vaadin.shared.ui.ui.UIState.class, new String[] {"errorMessage", "readOnly", "pollInterval", "registeredEventListeners", "tooltipConfiguration", "description", "width", "resources", "primaryStyleName", "immediate", "id", "loadingIndicatorConfiguration", "caption", "enabled", "styles", "tabIndex", "pageState", "localeServiceState", "height", "pushConfiguration", "overlayContainerLabel", });
            ...
            store.setProperties(com.vaadin.shared.ui.checkbox.CheckBoxState.class, new String[] {"immediate", "propertyReadOnly", "resources", "id", "enabled", "modified", "required", "readOnly", "height", "primaryStyleName", "tabIndex", "hideErrors", "width", "caption", "description", "styles", "errorMessage", "registeredEventListeners", "checked", });
            store.setProperties(com.vaadin.shared.ui.table.TableState.class, new String[] {"caption", "registeredEventListeners", "hideErrors", "height", "required", "errorMessage", "description", "primaryStyleName", "width", "enabled", "resources", "immediate", "propertyReadOnly", "styles", "modified", "tabIndex", "readOnly", "id", });
            store.setProperties(com.vaadin.shared.JavaScriptExtensionState.class, new String[] {"resources", "enabled", "registeredEventListeners", "rpcInterfaces", "callbackNames", });
            store.setProperties(com.vaadin.shared.ui.form.FormState.class, new String[] {"primaryStyleName", "propertyReadOnly", "caption", "immediate", "required", "modified", "footer", "height", "errorMessage", "id", "readOnly", "hideErrors", "resources", "tabIndex", "layout", "width", "description", "registeredEventListeners", "styles", "enabled", });
            store.setProperties(com.vaadin.shared.ui.button.NativeButtonState.class, new String[] {"description", "primaryStyleName", "errorMessage", "width", "id", "height", "tabIndex", "resources", "clickShortcutKeyCode", "styles", "caption", "disableOnClick", "htmlContentAllowed", "iconAltText", "registeredEventListeners", "enabled", "readOnly", "immediate", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.HorizontalSplitPanelState.class, new String[] {"splitterState", "height", "primaryStyleName", "description", "id", "secondChild", "width", "enabled", "caption", "styles", "resources", "readOnly", "errorMessage", "registeredEventListeners", "firstChild", "immediate", });
            store.setProperties(com.vaadin.shared.ui.JavaScriptComponentState.class, new String[] {"callbackNames", "primaryStyleName", "description", "errorMessage", "readOnly", "resources", "width", "styles", "registeredEventListeners", "rpcInterfaces", "id", "enabled", "height", "caption", "immediate", });
            ...
            store.setProperties(com.vaadin.shared.ui.embedded.EmbeddedState.class, new String[] {"description", "registeredEventListeners", "alternateText", "enabled", "primaryStyleName", "caption", "id", "width", "errorMessage", "height", "immediate", "readOnly", "styles", "resources", });
            store.setProperties(com.vaadin.shared.ui.AbstractMediaState.class, new String[] {"autoplay", "readOnly", "caption", "primaryStyleName", "styles", "sourceTypes", "errorMessage", "id", "htmlContentAllowed", "height", "resources", "showControls", "sources", "immediate", "registeredEventListeners", "altText", "width", "muted", "enabled", "description", });
            store.setProperties(com.vaadin.shared.ui.ui.UIState.LocaleServiceState.class, new String[] {"localeData", });
            store.setProperties(com.vaadin.shared.ui.progressindicator.ProgressBarState.class, new String[] {"tabIndex", "readOnly", "errorMessage", "modified", "registeredEventListeners", "width", "height", "state", "id", "styles", "immediate", "enabled", "propertyReadOnly", "description", "indeterminate", "primaryStyleName", "caption", "required", "resources", "hideErrors", });
            store.setProperties(com.vaadin.shared.ui.ui.PageState.class, new String[] {"hasResizeListeners", });
            store.setProperties(com.vaadin.shared.AbstractFieldState.class, new String[] {"readOnly", "hideErrors", "width", "immediate", "styles", "height", "resources", "description", "id", "propertyReadOnly", "caption", "tabIndex", "errorMessage", "primaryStyleName", "required", "modified", "registeredEventListeners", "enabled", });
            store.setProperties(com.vaadin.shared.ui.popupview.PopupViewState.class, new String[] {"readOnly", "resources", "styles", "width", "caption", "primaryStyleName", "errorMessage", "registeredEventListeners", "immediate", "hideOnMouseOut", "html", "enabled", "description", "id", "height", });
            store.setProperties(com.vaadin.shared.ui.image.ImageState.class, new String[] {"primaryStyleName", "description", "alternateText", "height", "styles", "id", "width", "enabled", "errorMessage", "resources", "registeredEventListeners", "readOnly", "caption", "immediate", });
            store.setProperties(com.vaadin.shared.ui.window.WindowState.class, new String[] {"primaryStyleName", "width", "resources", "styles", "resizeLazy", "height", "positionY", "centered", "immediate", "draggable", "windowMode", "tabIndex", "id", "description", "readOnly", "positionX", "modal", "scrollTop", "enabled", "registeredEventListeners", "scrollLeft", "caption", "errorMessage", "resizable", });
            store.setProperties(com.vaadin.shared.ui.ui.UIState.LocaleData.class, new String[] {"dayNames", "am", "pm", "twelveHourClock", "name", "dateFormat", "monthNames", "shortDayNames", "hourMinuteDelimiter", "firstDayOfWeek", "shortMonthNames", });
            store.setProperties(com.vaadin.shared.ui.datefield.PopupDateFieldState.class, new String[] {"id", "rangeEnd", "readOnly", "primaryStyleName", "textFieldEnabled", "height", "enabled", "errorMessage", "styles", "resources", "required", "modified", "description", "tabIndex", "immediate", "caption", "registeredEventListeners", "rangeStart", "width", "propertyReadOnly", "hideErrors", "descriptionForAssistiveDevices", });
            store.setProperties(com.vaadin.shared.ui.twincolselect.TwinColSelectState.class, new String[] {"caption", "styles", "required", "primaryStyleName", "hideErrors", "propertyReadOnly", "height", "readOnly", "tabIndex", "width", "resources", "modified", "registeredEventListeners", "errorMessage", "description", "id", "enabled", "immediate", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.calendar.CalendarState.Event.class, new String[] {"description", "timeTo", "allDay", "caption", "dateFrom", "styleName", "timeFrom", "index", "dateTo", });
            store.setProperties(com.vaadin.shared.ui.calendar.CalendarState.Day.class, new String[] {"week", "date", "localizedDateFormat", "dayOfWeek", });
            store.setProperties(com.vaadin.shared.ui.calendar.CalendarState.Action.class, new String[] {"endDate", "startDate", "actionKey", "iconKey", "caption", });
            store.setProperties(com.vaadin.shared.ui.calendar.CalendarState.class, new String[] {"firstVisibleDayOfWeek", "errorMessage", "lastHourOfDay", "registeredEventListeners", "scroll", "immediate", "format24H", "actions", "height", "dayNames", "resources", "firstDayOfWeek", "width", "monthNames", "readOnly", "styles", "primaryStyleName", "caption", "description", "days", "events", "firstHourOfDay", "now", "enabled", "lastVisibleDayOfWeek", "id", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerGradientState.class, new String[] {"immediate", "styles", "readOnly", "height", "id", "cursorY", "cursorX", "resources", "enabled", "registeredEventListeners", "width", "caption", "bgColor", "primaryStyleName", "errorMessage", "description", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerState.class, new String[] {"caption", "showDefaultCaption", "registeredEventListeners", "height", "styles", "primaryStyleName", "enabled", "color", "errorMessage", "width", "description", "resources", "htmlContentAllowed", "immediate", "id", "readOnly", "popupVisible", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerGridState.class, new String[] {"id", "description", "registeredEventListeners", "width", "changedX", "changedY", "height", "resources", "caption", "enabled", "primaryStyleName", "rowCount", "immediate", "readOnly", "errorMessage", "columnCount", "changedColor", "styles", });
